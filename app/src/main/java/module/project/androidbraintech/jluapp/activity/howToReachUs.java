...
public class howToReachUs extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng jlu = new LatLng(23.203387,77.294505);
        mMap.addMarker(new MarkerOptions().position(jlu).title("How to reach JLU"));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(jlu,15));
