 ...
 */
public class ProspectiveStudentsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
   ...
   public ProspectiveStudentsAdapter(Context context){
    ...
    ArrayList<ContentHomeScreenItems> setAdapterList(){
        ...
        content=new ContentHomeScreenItems(7,"Track Your Application",R.drawable.guestimage);
        list.add(content);

        content=new ContentHomeScreenItems(8,"Campus Map",R.drawable.guestimage);
        list.add(content);

        content=new ContentHomeScreenItems(9,"City Of Bhopal",R.drawable.bpl);
        list.add(content);

        content=new ContentHomeScreenItems(10,"How To Reach Us",R.drawable.imgg11);
        list.add(content);
